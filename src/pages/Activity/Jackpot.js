...
const Jackpot = () => {
 ...
 const images = [img6,img1, img2, img3, img4, img5];
      ...
      <div className="w-[450px] bg-[#242424] text-white rounded-lg overflow-y-auto min-h-screen p-2">
        ...
        >
          {images.map((img, index) => (
            <div 
              key={index} 
              className={`flex flex-col items-center flex-shrink-0 cursor-pointer rounded-lg px-10 mt-6 py-1 ${
                selectedTab === index ? '' : 'bg-[#333332]'
              }`}
              style={
                selectedTab === index
            ...
            >
              ...
              <span className={`text-sm ${
                selectedTab === index ? 'text-black' : 'text-gray-400'
              }`}>
                {tabNames[index]}
              </span>
            </div>
        ...
        <div className="max-w-[420px] w-full bg-[#333332] rounded-lg  p-2 shadow-lg">
          ...
          <div className="flex items-center mb-5">
            ...
            <span className="text-xl font-semibold text-white">73.00</span>
          </div>
  ...
  <div className="bg-[#4d4d4c] p-2 rounded">
    ...
    <div className="text-[#dd9138] text-lg font-medium">0</div>
  </div>
  <div className="bg-[#4d4d4c] p-2 rounded">
    <div className="text-[#a8a5a1] text-sm">Total rebate</div>
    <div className="text-[#dd9138] text-lg font-medium">0.05</div>
  </div>
</div>
  ...
  <div className="bg-[#333332] rounded-lg p-2 mb-4">
    <div className="flex justify-between items-center mb-2">
      <span className="text-lg font-bold">Lottery</span>
      <span className="text-green-500">Completed</span>
    </div>
    <div className="text-gray-400 text-xs mb-4">2025-03-10 01:00:31</div>
    ...
    <div className="flex items-start">
      ...
      <div className="flex-grow space-y-4 -mt-1">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-[#d9ac4f]">0.05</span>
        </div>
      </div>
    </div>
  </div>
          ...
          <button className="w-full border border-[#d9ac4f] text-[#d9ac4f] p-2 rounded-full">
            All history
          </button>
        </div>
      </div>
