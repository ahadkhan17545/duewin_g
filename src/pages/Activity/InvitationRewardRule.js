    ...
    <div className="bg-[#242424] min-h-screen w-full flex flex-col items-center justify-center p-4 font-serif">
      ...
      <div className="w-full max-w-md mx-auto mt-10">
          ...
          <table className="w-full border-collapse table-fixed">
            ...
            <tbody>
              {rows.map((row, rowIndex) => (
                ...
                >
                  <td className="py-3 px-2 text-center text-[#a8a5a1] text-lg  font-sans">{row.people}</td>
        ...
        <div className="bg-gray-800 rounded-lg overflow-hidden w-full">
          {/* Rules Header */}
          <div
  className="bg-[#3a3947] text-white py-3 px-2 text-center "
  style={{
            ...
            <ul className="space-y-3">
              {rules.map((rule, index) => (
                <li key={index} className="flex items-start">
                  ...
                  <span className="text-base  text-[#a8a5a1]">{rule}</span>
                </li>
              ))}
            </ul>
          </div>
