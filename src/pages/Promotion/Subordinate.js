        ...
        {searchResult && searchResult !== "not-found" ? (
          <div className="bg-[#333332] rounded-lg p-3 mb-3">
            <div className="flex justify-start items-center mb-2">
              <span className="text-xs text-white opacity-60">UID: {searchResult?.user_id}</span>
            </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-xs text-white opacity-60">{searchResult?.level?.replace("level", "")}</span>
            </div>

            <div className="flex justify-between items-center ">
              <span className="text-xs text-white opacity-60">Deposit amount</span>
...
{copiedUID === user.user_id && (
  <span className="text-white text-xs ml-2">Copied!</span>
                ...
                <div className="flex justify-between items-center ">
                  <span className="text-xs text-white opacity-60 opacity-60">Level</span>
                  <span className="text-xs text-white opacity-60">{levelIndex + 1}</span>
                </div>
