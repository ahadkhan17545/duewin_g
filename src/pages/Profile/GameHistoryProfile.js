...
function GameHistoryProfile() {
  ...
  useEffect(() => {
    ...
    setSelectedOption(currentOptions ? currentOptions[0] : "All");
  }, [selectedIndex]);
    ...
    <div className="bg-[#242424] w-full min-h-screen flex flex-col items-center">
      ...
      <div className="bg-[#242424] flex flex-col w-full max-w-[400px] mx-auto items-center mt-12">
        ...
        <div className="bg-[#242424] flex flex-col items-center justify-start w-full max-w-[400px] mx-auto">
          ...
          <div className="bg-[#333332] w-full rounded-md p-3 shadow-lg border border-gray-700">
  <div className="flex justify-between items-center mb-2">
    <h2 className="text-white font-semibold text-lg">Win Go</h2>
    <span className="text-green-500 font-medium text-lg">Win</span>
  </div>

  <p className="text-gray-500 text-xs mb-2">2025-04-10 00:06:46</p>
  ...
  <div className="flex">
    ...
    <div className="space-y-2 text-sm flex-1">
      <div className="flex justify-between">
        ...
        <span className="text-white">Win Go 30 second</span>
      </div>
      <div className="flex justify-between">
        <span className="text-white">Period</span>
        <span className="text-white">20250409100052234</span>
      </div>
      <div className="flex justify-between">
        <span className="text-white">Order number</span>
        <span className="text-white">WG20250410000646507117e</span>
      </div>
      <div className="flex justify-between">
      ...
      <div className="flex justify-between">
        ...
        <span className="text-yellow-500 font-semibold">₹85.00</span>
      </div>
    </div>
  </div>
</div>
